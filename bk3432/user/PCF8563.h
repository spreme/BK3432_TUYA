...
void          PCF8563_GetTime                    (unsigned char PCF_Format, tuya_ble_time_struct_data_t* PCF_DataStruct);  //PCF8563读取时间信息
 
void          PCF8563_SetDate                    (unsigned char PCF_Format, unsigned char PCF_Century, tuya_ble_time_struct_data_t* PCF_DataStruct);  //PCF8563写入日期信息
void          PCF8563_GetDate                    (unsigned char PCF_Format, unsigned char *PCF_Century, tuya_ble_time_struct_data_t* PCF_DataStruct);  //PCF8563读取日期信息
