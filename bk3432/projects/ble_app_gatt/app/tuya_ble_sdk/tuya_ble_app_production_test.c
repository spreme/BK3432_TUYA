...
#define tuya_ble_prod_monitor_timeout_ms  6000  //60s

tuya_ble_timer_t tuya_ble_xTimer_prod_monitor;

void tuya_ble_vtimer_prod_monitor_callback(void)
{
...
{
    ke_timer_set(APP_TUYA_PROD_MONITOR_TIMER,TASK_APP ,tuya_ble_prod_monitor_timeout_ms);
}

static void tuya_ble_prod_monitor_timer_stop(void)
{
    ke_timer_clear(APP_TUYA_PROD_MONITOR_TIMER,TASK_APP); 
}
