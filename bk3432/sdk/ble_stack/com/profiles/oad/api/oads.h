...
#define OAD_BLOCK_APP_MAX        (0x640)  //(25K *1024*4) /64
#define OAD_BLOCK_STACK_MAX		 (0x3E00)

typedef void (*FUNCPTR)(void);

#define SEC_IMAGE_OAD_HEADER_APP_FADDR    (0x1b010)
#define SEC_IMAGE_OAD_HEADER_STACK_FADDR	 (0x2010) 

#define SEC_BACKUP_OAD_HEADER_FADDR		 (0x21400) //133kb * 1024
#define SEC_BACKUP_ALLOC_START_FADDR		 (0x21400) //(133KB)
#define SEC_BACKUP_ALLOC_END_FADDR		 (0x27c00) //(159KB)
/*********************************************************************
 * MACROS
 */   
